...
main() {
    ...
    shapeit5_phase_common --input ${tar_bcf_name} --reference ${ref_bcf_name} ${map_opt} --region ${reg} --output-format ${out_fmt} --output ${out_pfx}.bcf --l ${out_pfx}.log --thread ${num_thr} ${shp_args}
